describe('Season 1 test suite',function()
{
    it ('test case',function()
    {
        ...
        element(by.xpath('(//span[contains(@class,"plugin-common__btn-start__text")])[26]')).click().then(function(){browser.sleep(20000)});

        //from here we have to write isomer code 

        element(by.className('plugin-simlaunch-btn')).click().then(function(){browser.sleep(30000)});
