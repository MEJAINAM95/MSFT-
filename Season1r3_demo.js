describe('Season 1 test suite',function()
{
   ...
   /*
     ...
     */   
        ...
        element(by.xpath('(//span[contains(@class,"plugin-common__btn-start__text")])[20]')).click().then(function(){browser.sleep(20000)});
        ...
        element(by.xpath('//label[@class="col-layout"][contains(.,"A. Catastrophe mitigation")]')).click();
