describe('Season 1 test suite',function()
{
    it ('test case',function()
    {
        ...
        element(by.id('userEmail')).sendKeys('m22@microsoft.com');
        ...
        element(by.xpath('//span[contains(.,"A. Negotiate favorable pricing agreements with new and existing midstream operators")]')).click();
        element(by.xpath('//span[contains(.,"C. Leverage AI analysis to hedge oil sales through trading desk")]')).click();
